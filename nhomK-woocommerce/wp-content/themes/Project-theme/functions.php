...
*/
    ...
    'after_title' => '</div>'
          ...
          $collection = array(
                'name' => __('Product of category', 'hayghe'),
...
function hayghe_styles()
{
    ...
    wp_register_script('jque-style', get_template_directory_uri() . '/js/jquery-3.4.1.min.js', 'all');
    ...
    wp_register_style('archivee-style', get_template_directory_uri() . './css/archive.css', 'all');
    wp_enqueue_style('archivee-style');


    wp_register_style('single-style', get_template_directory_uri() . './css/single.css', 'all');
    ...
    wp_register_style('product-style', get_template_directory_uri() . './css/product-categoty.css', 'all');
    wp_enqueue_style('product-style');

    wp_register_style('slidebanner-style', get_template_directory_uri() . './css/slidebanner.css', 'all');
    wp_enqueue_style('slidebanner-style');
...
/*-------------------------------------------------- DOACTION AJAX --------------------------*/
add_action('wp_ajax_menu_ajax', 'menu_ajax');
